...
export class WalletService {
    constructor(
        ...
        private readonly walletStockRepository: WalletStockRepository,
    ) {}
...
//#region i guess something like this
    public getWalletStocks = async (wallet_id: string): Promise<WalletResponse> => {    
        ...
        const walletStock = await this.walletStockRepository.getWalletStocks(wallet_id);
        return {
            id: wallet_id,
    ...
    public getWalletStockQuantity = async (wallet_id: string, stock_name: string): Promise<number> => {
        ...
        return (await this.walletStockRepository.getWalletStockQuantity(wallet_id, stock_name))??0;
    }
//#endregion
